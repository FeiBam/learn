...
a.add(114514,{data:'野兽前辈'},5000)
setTimeout(()=>{a.removeTimeoutData()},5000)
setTimeout(()=>{console.log(a.select(114514))},3000)
setTimeout(()=>{console.log(a.select(114514))},6000)
setTimeout(()=>{console.log(a.select(114514))},10000)